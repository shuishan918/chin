from usecase5.uc5_4_get_copys_sum import uc5_4_get_copys_sum_510


#db_copy = get_copys_sum_510("BWE850",[],["VCP5509","VCP5583","VCP5584","VCP5577","BF04XREC"],["P73X50","P84X50"])
#print(f'結果：{db_copy}')

db_copy = uc5_4_get_copys_sum_510("BF2010",["BF2010A","BF2010B"],["VCP5509","VCP5583","VCP5584","VCP5577","BF04XREC"],["BXXX04","SECURE"])
print(f'結果：{db_copy}')
