...
def get_db_copy_from_pgm(module_name_list: list[str],target_parameter_list:list[str])->list:
    db_copy = None
    try:
...
def get_db_copy_from_copy_name(target_parameter_list:list[str],copy_list: list[str])->list[str]:
